...
namespace Ws_prectoex.Data
{
    ...
    public class PartidaPendientesEstRef
    {
        public string cod_ordtra { get; set; }
        public string nom_cliente { get; set; }
        public string cod_tela { get; set; }
        public string des_color { get; set; }
        public string fec_descarga { get; set; }
        public string hora_transcurrido { get; set; }
        public string min_transcurrrido { get; set; }
        public string tono_aprob { get; set; }
        public string flg_ingreso_sistema { get; set; }
        public string des_responsable { get; set; }
